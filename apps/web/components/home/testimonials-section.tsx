...
const testimonials = [
  ...
  },
  {
    ...
    content: 'The BMW M8 Competition was perfect for my photoshoot in Monaco. The team at Valore understood exactly what I needed and went above and beyond to accommodate my schedule.',
    rating: 5,
    ...
    <div>
      ...
      >
        ...
        <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
          Discover why discerning individuals choose Valore Rental for their luxury automotive experiences
        </p>
      </motion.div>
