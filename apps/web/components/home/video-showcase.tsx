            ...
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-slate-900">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">BMW M8 Competition</p>
                    <p className="text-xs text-neutral-300">Full Power Unleashed</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-slate-900">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">RS7 & M8 Competition</p>
                    <p className="text-xs text-neutral-300">Dance of Speed and Luxury</p>
                  </div>
                </div>
              </div>
            </div>
