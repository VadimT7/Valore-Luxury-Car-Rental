...
function generateBookingConfirmationTemplate(booking: any): EmailTemplate {
  ...
  const subject = `Booking Confirmation - ${booking.car.displayName} | Valore Rental`
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>
            Thank you for choosing Valore Rental. Your booking for the 
          ...
          <p>
            ...
            <a href="mailto:concierge@valorrental.com">concierge@valorrental.com</a> 
            or call us at +1 (555) 123-4567.
          </p>
        </div>
        
        <div class="footer">
          <p>© ${new Date().getFullYear()} Valore Rental. All rights reserved.</p>
          <p>
  ...
  const text = `
Valore Rental - Booking Confirmation

Dear ${booking.user?.name || booking.guestName || 'Valued Customer'},

Thank you for choosing Valore Rental. Your booking for the ${booking.car.displayName} has been confirmed.
...
Pickup Location: ${booking.pickupType === 'DELIVERY' ? 'Delivery to your location' : 'Valore Rental Showroom'}
...
If you have any questions or need to make changes to your booking, please contact us at concierge@valorrental.com or call +1 (555) 123-4567.

© ${new Date().getFullYear()} Valore Rental. All rights reserved.
  `.trim()
...
function generatePickupReminderTemplate(booking: any): EmailTemplate {
  ...
  const subject = `Pickup Reminder - ${booking.car.displayName} Tomorrow | Valore Rental`
  ...
  const html = `
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1a1a1a; margin: 0; padding: 20px;">
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f9f9f9; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Location:</strong> ${
            booking.pickupType === 'DELIVERY' 
              ...
              : 'Valore Rental Showroom, 123 Luxury Avenue, Monaco'
          }</p>
        </div>
        ...
        <p>Best regards,<br>The Valore Rental Team</p>
      </div>
    </body>
    </html>
  `
